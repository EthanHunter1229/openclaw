...
- Security/host env: block Python package index override env vars (PIP_INDEX_URL, PIP_EXTRA_INDEX_URL, UV_INDEX, UV_INDEX_URL, etc.) so package fetches cannot be redirected through a caller-supplied index. (GHSA-3qpv-xf3v-mm45) Thanks @02-Coding.
